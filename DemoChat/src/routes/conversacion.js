module.exports = app => {
    ...
    const access_token = "EAAH2HmDtqqQBALU7uEEtphlXcFD0iNUhx5WsUOghhxo88BZBUZBNUYHHwLTg76wnvvtrMypcSh1AtF4CRd3fNKegHPPpM89H48Nt0ukTva9oxMaVMjkUy0TLmq4FaQg7avgjjjxJnQIOPz8W7KjKiPnejXUofv0ZBlBG6YP7dfBIxADc9A4JPu0kqoULu8ZD";
    ...
    app.post('/webhook', function (req, res) {
        ...
        if (webhook_event.messaging) {
            webhook_event.messaging.forEach(event => {
                ...
                // defaultMessage(event.sender.id);
                ...
                console.log("Parametros batzon",params);
                assistant.message(params, (err, response) => {
                    ...
                    if (err) {
                      ...
                      const msbABot=response.output.text[0];
                      console.log("Mensaje de asistente",msbABot);
                        const messageData = {
                            "recipient": {
                                "id": event.sender.id
                            },
